...
switch ($Userrole) {
      case 'Admin':
      {
        $loginsql="SELECT * FROM `login` WHERE useremail='$username'";
   ...
   <div class="container" style="padding-top: 2%;padding-bottom: 10%;width: 35%; height:70%;border-radius: 15px 15px 15px 15px;background-color:;margin-top:50px;" >
                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="background-color:#467fd0;height:60px;">
                        <h3 class="panel-title"style="color:white;">Counsellor Login</h3><br><br>
                    </div>
        ...
        <label>Password: </label>
         ...
         <i class="glyphicon glyphicon-lock form-control-feedback"></i>
                  ...
                  <a href="regist.php" class="btn btn-primary btn btn-block" style="border-color:#682b33" role="button">Register Account</a>
