                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-header">
                          <td><label style="color:#467fd0">All Clients</label></td>
                    ...
                    $query="SELECT  * FROM clients";
                                    ...
                                    if ($count >0){
                                      ...
                                      while ($row=mysqli_fetch_array($result)){
                                           ...
                                           <td>'.$row['location'].'</td>
                                      ';
echo '<td > <a href="updateappoint.php?variable1='.$row['name'].'&variable2='.$row['idnum'].'&variable3='.$row['dob'].'&variable5='.$row['phone'].'&variable6='.$row['address'].'&variable8='.$row['id'].'" class="btn btn-primary" role="button" >Assign Counsellor/Venue</a></td>';

  echo '<td ><button class="viewprof btn btn-success" name="id" data-id1="'.$row['id'].'">Approve Payment</button></td>';
...
echo'<td><a href="deleteappoint.php?id='.$row['id'].'" class="btn btn-danger " role="button" id="id" data-id2="'.$row['id'].'" >Delete</a></td>';
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="border-radius:10px 10px 10px 10px;width: 70%;min-width: 200px";>
    <div class="modal-content">
      ...
      <div class="modal-footer" style="background-color:#467fd0; ">
