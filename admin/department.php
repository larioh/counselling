                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-header">
                          <div class="panel-header">
                         <td><a href="addDepartment.php" class="btn btn-primary" role="button">Add Department</a></td>
                        </div>
                    ...
                    $query="SELECT * FROM departmentlist";
...
echo'<td><a href="deletedepart.php?Num='.$row['Num'].'" class="btn btn-danger " role="button" Num="Num" data-id2="'.$row['Num'].'" >Delete</a></td>';
                                            echo '</tr>';
                                            $counts++;
                                      }
                                    }
