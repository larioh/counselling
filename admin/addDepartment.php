...
require('dbconn.php');
 ...
 if(isset($_POST['submit'])){
  $cname = $_POST['cname'];
   ...
   $query="INSERT INTO  `counselling` .`departmentlist` (`DepartName`) VALUES('$cname')";
...
<script type="text/javascript">
   ...
   <div class="container">
        ...
        <div class="panel-body"style="background-color:#467fd0;margin-top: 0%;padding-bottom: 5px;border-radius: 15px 15px 15px 15px;color:white; ">
            ...
            <form action="addDepartment.php" method="post"  class="form-horizontal" enctype="multipart/form-data">
                <div class="container" style="padding-top: 2%;padding-bottom: 2%; width: 49%;min-width:100px;border-radius: 15px 15px 15px 15px;" >

  <div class="form-group">
     <div class="form-group">
      <label for="inputname"class="col-sm-6 control-label">Department Name</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" name="cname" placeholder="" required="true"
        >
      </div>
