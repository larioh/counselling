                    ...
                    $query="SELECT * FROM counsellors";
                                    ...
                                    if ($count >0){
                                      ...
                                      while ($row=mysqli_fetch_array($result)){
                                           ...
                                           <td>'.$row['Counsellor_idno'].'</td>
                                           <td>'.$row['Counsellor_phone'].'</td>
                                           <td>'.$row['Counsellor_email'].'</td>
                                           <td>'.$row['Counsellor_location'].'</td>
                                           ';
echo'<td><a href="deletecounsellor.php?DepID='.$row['DepID'].'" class="btn btn-danger " role="button" DepID="DepID" data-id2="'.$row['DepID'].'" >Delete</a></td>';
                                            echo '</tr>';
                                            $counts++;
                                      }
                                    }
